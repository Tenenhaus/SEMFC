#' Inner Static Visualization Network RGCCAC
#'
#'path_diagram_inner allows to display an inner graph of an RGCCAC object 
#'
...
#'
#' @return
#' Inner static graph for rgcca object 
#' @export
#'
#' @examples
#' #' path_diagram_inner(fit.rgccac, display_numbers = TRUE,
...
path_diagram_inner = function(model, display_numbers = TRUE,
                              ...
                              node_options_MV = list(shape = "box",  color = "black"))
{
  ...
  plotCall <- BuildCall_inner(model = model, display_numbers = display_numbers,
